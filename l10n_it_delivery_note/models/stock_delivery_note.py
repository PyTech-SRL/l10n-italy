...
class StockDeliveryNote(models.Model):
    ...
    def write(self, vals):
        ...
        if state_changed:
            ...
            delivery_notes = old_draft_delivery_notes | new_draft_delivery_notes

            # The invoice status of the Delivery Note Lines
            # depends on whether the Delivery Note is/was in draft.
            delivery_notes.sale_ids._assign_delivery_notes_invoices(
                delivery_notes.sale_ids.invoice_ids.ids
            )
